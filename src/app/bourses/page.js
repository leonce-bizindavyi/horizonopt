...
export default function Page() {
  return (
    <main className="my-32 w-full dark:bg-dark flex justify-center font-mr">
      ...
      text-6xl font-bold w-full capitalize xl:text-8xl text-center`}>Bourses</h1>
        <h2 className={`inline-block text-dark dark:text-light
      text-5xl font-bold w-full capitalize xl:text-6xl text-center mt-4 tracking-wide leading-snug`}>Page Of all Bourses</h2>
        <Link
          href="/"
